					...
					<ul>
						<li>
				            <div id="homeBox_my" class="col-sm-4" >
				                <div onclick="location.href='${path}/mypage/order'" class="one_fourth_my">
				        ...
				        <li>
				            <div id="homeBox_my" class="col-sm-4">
				                <div onclick="location.href='${path}/mypage/basket'" class="one_fourth_my">
				        ...
				        <li>
				            <div id="homeBox_my" class="col-sm-4">
				                <div onclick="location.href='${path}/mypage/likey'" class="one_fourth_my">
