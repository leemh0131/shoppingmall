        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-6 p-3">
          		...
          		<ul class="list-unstyled">
            		<li class="Main"> <a href="${path}/" class="text-info">Home</a></li>
            		<li class="Main"> <a href="${path}/board/boardList" class="text-info">FAQ</a></li>
		            <li class="Main"> <a href="${path}/roducts/productList" class="text-info">Best</a></li>		            
          		</ul>
        	</div>
